...
class PetServiceImplTest {
    ...
    @Mock
    private IPetRepository groupsRepository;
    private IPetService underTest;

    //перед каждым тестом получаем чистые данные
    @BeforeEach
    public void setUp() {
        underTest = new PetServiceImpl(groupsRepository);
    }
    ...
    void createEntity() {
        ...
        ArgumentCaptor<Pet> groupsArgumentCaptor =
        ...
        Pet groupsArgumentCaptorValue = groupsArgumentCaptor.getValue();
